...
A device whose sticker no longer matches it cannot be reached at all, which strands a technician who has no way to access the device to obtain the  a replacement on the spot.
