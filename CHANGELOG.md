...
- **deps:** Update target-tuples to 0.16.0 - ([63b3223](https://github.com/beyondessential/bestool/commit/63b32234c910b3392d1f23963e0e44ee209bed96))
- **deps:** Upgrade sysinfo to 0.38.4 - ([c04772f](https://github.com/beyondessential/bestool/commit/c04772f03b2a385d6179a85ac05bdcc63b218fd3))
- **deps:** Upgrade reqwest to 0.13 - ([5fa021b](https://github.com/beyondessential/bestool/commit/5fa021bc93312fc72a86249ed8c7b74cc807961f))
- **deps:** Remove facet - ([a6184bf](https://github.com/beyondessential/bestool/commit/a6184bfc662a98c17ea350198fddaeafce31991d))
- **deps:** Upgrade turso to 0.5.1 - ([fed787d](https://github.com/beyondessential/bestool/commit/fed787d70bedeab333eb28737424f4f4b6a01442))
- **deps:** Move sysinfo to workspace - ([f9825ce](https://github.com/beyondessential/bestool/commit/f9825ce669d4e081f4e78dc1c0609ec9f9342f87))
- **deps:** Upgrade signal-hook to 0.4.3 - ([7969fc5](https://github.com/beyondessential/bestool/commit/7969fc5ed85916c51d143495ef86d207d7696463))
- **deps:** Upgrade rust_xlsxwriter to 0.94.0 - ([beeb31e](https://github.com/beyondessential/bestool/commit/beeb31ebba1e9551b672af04f8d24cc6b70f92e3))
- **deps:** Upgrade rand to 0.10.0 - ([12d097c](https://github.com/beyondessential/bestool/commit/12d097ca3f2ec6328d921488191207d734693cb7))
- **deps:** Upgrade trycmd to 1.1.1 - ([44a833d](https://github.com/beyondessential/bestool/commit/44a833dc9bd79f672d9bd0c50e244564db8ed726))
- **deps:** Update lockfile - ([1405d19](https://github.com/beyondessential/bestool/commit/1405d19736d0239d5919972354f8002a5aa266d5))
- **deps:** Switch bestool-postgres to aws-lc-rs - ([3996c3e](https://github.com/beyondessential/bestool/commit/3996c3e34ec5b7febe240986b64459813fcfb232))
- **deps:** Configure aegis to use pure-rust crypto - ([65da4b4](https://github.com/beyondessential/bestool/commit/65da4b468f8cec7b7feaca5fd4197172c1993714))
- **fix:** Use explicit aws-lc-rs CryptoProvider for rustls TLS connector - ([6a8bde9](https://github.com/beyondessential/bestool/commit/6a8bde94cd4573d351dbb9bc6f35bbbc24aef5df))


- **feat(alertd):** Watchdog healthcheck and Windows service failure recovery (#273) - ([61c84f7](https://github.com/beyondessential/bestool/commit/61c84f73e7cd01de2ab23774bda5e052a10deb10))
- **feat(alertd):** KAM-483: re-implement slack integration via webhook targets (#269) - ([7cc44e3](https://github.com/beyondessential/bestool/commit/7cc44e3f676d5301a5279ca734a7908e55b3731b))
- **feat(alertd):** Add database health check with database-down event (#274) - ([26e0b32](https://github.com/beyondessential/bestool/commit/26e0b32cb663c56b419a60284833561350cc35f4))

- **feat(tamanu):** KAM-486: add meta-ticket subcommand (#270) - ([3ada00a](https://github.com/beyondessential/bestool/commit/3ada00ade5c8df53af1fa728d48a30b531ff9c09))
---
## [1.4.0](https://github.com/beyondessential/bestool/compare/v1.3.9..v1.4.0) - 2026-01-07
...
---
## [1.3.9](https://github.com/beyondessential/bestool/compare/v1.3.8..v1.3.9) - 2025-12-24


- **deps:** Update transitives - ([8ef1645](https://github.com/beyondessential/bestool/commit/8ef1645e41b62cc9c6e481f574fb771300d186b4))


- **feat(psql):** Add \default - ([67a9ac9](https://github.com/beyondessential/bestool/commit/67a9ac9f95c2e8ffe9bcb589fb8276086b4cdf5c))
- **fix(psql):** Crash on invalid metacommand input - ([4a74713](https://github.com/beyondessential/bestool/commit/4a74713759faf99d85ab9dafbcb513d7bf478370))
---
...
- **feat(psql):** Stop polluting history with snippets - ([efacbab](https://github.com/beyondessential/bestool/commit/efacbabe82e3997e8ea2a3ec91c80766b8b20082))
- **feat(psql):** Add \snip edit - ([15344e2](https://github.com/beyondessential/bestool/commit/15344e27fa6ea4c6db0f7c21ab04e41c69dc98e6))
...
- **feat(psql):** Add ability to load snippets from custom source - ([2a6ee02](https://github.com/beyondessential/bestool/commit/2a6ee022089756603638dbbe13c3619398f057f9))
...
- **fix(tests):** Mark unix-only tests as such - ([5e9b43b](https://github.com/beyondessential/bestool/commit/5e9b43b4ebd67f27a59e1ee2fdab5f3d9ab21119))
---
## [1.3.6](https://github.com/beyondessential/bestool/compare/v1.3.5..v1.3.6) - 2025-12-18


- **deps:** Transitives - ([dbb4d41](https://github.com/beyondessential/bestool/commit/dbb4d41097165b48174c4a9a79d7baf8b2af2bc9))
...
- **feat(alertd):** Response to system time change (on windows) - ([5f66fa5](https://github.com/beyondessential/bestool/commit/5f66fa55160878e945014e0661e32536c85c8f52))
...
- **fix(alertd):** Try to delete the service even if stopping it fails - ([9cd6c01](https://github.com/beyondessential/bestool/commit/9cd6c01f0a93ed1093b0180a1dce70117f5d44f3))
- **fix(alertd):** Fix param order - ([54cd444](https://github.com/beyondessential/bestool/commit/54cd4449469829adb2ea6748f6d64196a560005d))
- **fix(alertd):** Unfuck the logfile path - ([b5062d9](https://github.com/beyondessential/bestool/commit/b5062d9e01dcdc92e69c0dfb32aaf61a13b6c687))
- **fix(alertd):** Fix service startup sequence - ([2d2be7f](https://github.com/beyondessential/bestool/commit/2d2be7f865aa1cdcdcbc0ecde9f9584aeb2bd3d4))
- **fix(alertd):** Start service from a copy to avoid locking the exec - ([c10e241](https://github.com/beyondessential/bestool/commit/c10e2410f904b3692800af08aef937cd06a20484))
- **tweak(alertd):** Add diagnostics and error help for service actions - ([f1aca8a](https://github.com/beyondessential/bestool/commit/f1aca8a0820f22ba47d7524843e7d621f50c014a))
- **tweak(alertd):** Wait for service to start when installing - ([c7e3358](https://github.com/beyondessential/bestool/commit/c7e33582450a136f8cd5448310a35840ad96e416))
- **tweak(alertd):** Write logs to a file - ([6bb6986](https://github.com/beyondessential/bestool/commit/6bb6986b107f1d04075b7e259fee42b12c4591c7))
...
- **fix(postgres):** Warnings - ([f26902c](https://github.com/beyondessential/bestool/commit/f26902c3350a7e4bfa5cafd15a640d2394a0f594))
---
...
- **deps:** Transitives - ([a7e661f](https://github.com/beyondessential/bestool/commit/a7e661ffbf96640a48a31ed2cba6bd655be82f7d))
...
---
## [1.3.2](https://github.com/beyondessential/bestool/compare/v1.3.1..v1.3.2) - 2025-11-28




- **fix(psql):** Don't block repl on schema cache warmup - ([213ca18](https://github.com/beyondessential/bestool/commit/213ca18d8abf3334f8f27a646208d8e79502c8ee))
---
## [1.3.1](https://github.com/beyondessential/bestool/compare/v1.3.0..v1.3.1) - 2025-11-28


- **fix:** Typos config - ([0372eb5](https://github.com/beyondessential/bestool/commit/0372eb5804c7645a4b1e31f7eecc5bd67f7bacde))
...
- **deps:** Transitives - ([3094390](https://github.com/beyondessential/bestool/commit/3094390636a4170be7b01638441c1dd8e0042421))
- **doc:** Update usage - ([5717e51](https://github.com/beyondessential/bestool/commit/5717e51010ecaeb4a0c586af40c80aab826c22f9))
- **feat:** Parse queries to extract column information - ([0c14a1f](https://github.com/beyondessential/bestool/commit/0c14a1fa3bf67409e5bd887e0bdc0a6cdab077a0))
- **fix:** Fix all errors - ([fd1f483](https://github.com/beyondessential/bestool/commit/fd1f4839a02c717315a5ad91b2f838d0cef07b00))


- **doc(psql):** Mention redaction - ([d370737](https://github.com/beyondessential/bestool/commit/d3707376205d20654b0bcf0c31e147fd8c216f6d))
...
- **feat(psql):** Add \R to toggle redactions - ([f9f6cbb](https://github.com/beyondessential/bestool/commit/f9f6cbba572cb14947713359935954488e5432f6))
...
- **feat(psql):** Add \debug redactions - ([1191e25](https://github.com/beyondessential/bestool/commit/1191e25cdd8c7e4aa62d498245052c93179c391c))
- **fix(psql):** Load schema at startup - ([2b3321c](https://github.com/beyondessential/bestool/commit/2b3321c2a27b380d4658bd59d3c462eef2b1f1ed))
- **fix(psql):** Display bug with redaction and wrapping - ([b18b07a](https://github.com/beyondessential/bestool/commit/b18b07a9a016b0a556eea2841db44141d0f9cf60))
...
- **refactor(psql):** Apply redactions before display (so it propagates to - ([f0f0095](https://github.com/beyondessential/bestool/commit/f0f0095229b54d35d8499868e23683e2d0a1a5d3))
- **refactor(psql):** Constantise this stuff a bit more - ([5d1b52a](https://github.com/beyondessential/bestool/commit/5d1b52a29625bf682e159d9f1608c5fb06f1b805))
- **tweak(psql):** Simpler debug logging for column refs - ([abb837d](https://github.com/beyondessential/bestool/commit/abb837d84543e7805673fbe23e00d79b2cf9ec90))
- **tweak(psql):** Handle weird databases that don't have version() - ([86e960a](https://github.com/beyondessential/bestool/commit/86e960a5796c5d68f8a5e13b38eefbd1e01bbd92))
---
...
- **tweak(docs):** Mention apt repo - ([8af51e5](https://github.com/beyondessential/bestool/commit/8af51e56aad8f44d674e15886bdb0738389cbcac))
---
## [1.2.6](https://github.com/beyondessential/bestool/compare/v1.2.5..v1.2.6) - 2025-11-26


- **deps:** Transitives - ([3166f6d](https://github.com/beyondessential/bestool/commit/3166f6df0de95675d850827fd087a85e1f5095fd))
- **deps:** Windows-service 0.8.0 - ([124ad37](https://github.com/beyondessential/bestool/commit/124ad378c94157bf74a498b26b174eb8743687b8))
- **deps:** Transitives - ([e6a4f58](https://github.com/beyondessential/bestool/commit/e6a4f58d9e7519e93710546476d35a8e51c9cb08))
- **feat:** Produce a deb - ([6e07df2](https://github.com/beyondessential/bestool/commit/6e07df2bf2a3a550ca01257fdee669890aa8c405))
- **feat:** Package more tools - ([6ccfdb3](https://github.com/beyondessential/bestool/commit/6ccfdb3639ad8fc6cc65998b543c9bbc2848f379))


- **fix(psql):** No more 11;rgb:2828/2c2c/3434 on the prompt - ([ea5cf06](https://github.com/beyondessential/bestool/commit/ea5cf061d2cb42abdb695cd58df8d364cc8199db))
- **tweak(psql):** Hide confusing row count on statements like TRUNCATE or - ([6a3454f](https://github.com/beyondessential/bestool/commit/6a3454f7a6c5e3f7e8f37131886260cfca46b3f7))
---
## [1.2.5](https://github.com/beyondessential/bestool/compare/v1.2.4..v1.2.5) - 2025-11-26




- **fix(psql):** \dn alone should print all schemas - ([1c3a032](https://github.com/beyondessential/bestool/commit/1c3a032a9d8f964e887313a05940c2cefd990c68))
- **refactor(psql):** Centralise colour management, and use brighter ones - ([35d56ca](https://github.com/beyondessential/bestool/commit/35d56ca5949399c5e16e4f324303be0ea69657ad))
---
...
- **fix(psql):** Parse dollar quotes - ([03cf355](https://github.com/beyondessential/bestool/commit/03cf35512eb1e423424d1f8aac99c235aee4c7f5))
- **fix(psql):** Parse block comments - ([5157ab1](https://github.com/beyondessential/bestool/commit/5157ab135802d4f7a873f38219d6d69a5cded20c))
...
---
## [1.2.2](https://github.com/beyondessential/bestool/compare/v1.2.1..v1.2.2) - 2025-11-21




- **fix(psql):** Handle quote characters in comments - ([79eb860](https://github.com/beyondessential/bestool/commit/79eb860592503d306989e8dacf85a9dc6de6d0ea))
- **refactor(psql):** Rework the multi-line parser to use winnow - ([1799769](https://github.com/beyondessential/bestool/commit/1799769e3292bc8a2772af41fe9af6f4a12a3304))
- **tweak(psql):** Auto-execute if input provided by \e or \i is missing a - ([4e01a73](https://github.com/beyondessential/bestool/commit/4e01a73c3b38b0a2ffde7f16df0d5997841608d7))
---
## [1.2.1](https://github.com/beyondessential/bestool/compare/v1.2.0..v1.2.1) - 2025-11-20


- **deps:** Update all for alertd - ([9c6893c](https://github.com/beyondessential/bestool/commit/9c6893c5d63288e98b4786d028532c6054a6caed))


- **test(alertd):** Fix tests - ([473dfab](https://github.com/beyondessential/bestool/commit/473dfab9f0cbcd5735eeee82596e636453b899cf))
---
## [1.2.0](https://github.com/beyondessential/bestool/compare/v1.1.16..v1.2.0) - 2025-11-20


- **deps:** Upgrade mailgun-rs - ([522b589](https://github.com/beyondessential/bestool/commit/522b5899c19c64e708ad946a261cfb1dffa7989b))
- **refactor:** Improve importing practices - ([c895b7a](https://github.com/beyondessential/bestool/commit/c895b7a09f333c15c1d62ad638e8e55bcb8cce82))


- **doc(alertd):** Add USAGE.md with copy of --help - ([f281d74](https://github.com/beyondessential/bestool/commit/f281d7449638652080eb452e1d919d0a292e0421))
- **doc(alertd):** Document the _targets format - ([e2d2e80](https://github.com/beyondessential/bestool/commit/e2d2e80b9bf00ecb5218e3289cdd493e7473a2dc))
- **doc(alertd):** Document the alerts format - ([903d234](https://github.com/beyondessential/bestool/commit/903d234a2dde539f6ab3b3f36a0d8594e82981db))
- **doc(alertd):** The `event:` sources are particular - ([f7862f6](https://github.com/beyondessential/bestool/commit/f7862f61c87b292f5c85e9de372c1cf5aed85d7f))
- **doc(alertd):** Include subcommand help in USAGE.md - ([3907558](https://github.com/beyondessential/bestool/commit/3907558246b46501ffbb2067489099d7c6692b0f))
- **doc(alertd):** Don't output ansi for the USAGE.md - ([bcf8271](https://github.com/beyondessential/bestool/commit/bcf82713bb104d6cff1f88fce3d12680ec51db00))
...
- **feat(alertd):** Send alert for alert errors - ([9c9721a](https://github.com/beyondessential/bestool/commit/9c9721a27a8b2ccfe165ca381ecb466d13368679))
- **feat(alertd):** HTTP server for reloads on windows - ([c2670fb](https://github.com/beyondessential/bestool/commit/c2670fb756005d91f2f5e8f93c7a14119a2a7e80))
- **feat(alertd):** Add /status endpoint - ([49bbdb9](https://github.com/beyondessential/bestool/commit/49bbdb9b4bc1a2e69f01644bcda85315c64a7c10))
...
- **feat(alertd):** Serve endpoint directory - ([67491b2](https://github.com/beyondessential/bestool/commit/67491b2b107cc4de48770e2c50d5d53a7ccf56d9))
...
- **feat(alertd):** Add native Windows service integration - ([d8c59ba](https://github.com/beyondessential/bestool/commit/d8c59bae41712ca2fa8069da737d50831589fcde))
- **feat(alertd):** Add HTTP event type and POST /alert endpoint - ([22ffd4c](https://github.com/beyondessential/bestool/commit/22ffd4cba4c3b2c7b0ed25bc62e0cdf9b249186d))
- **feat(alertd):** Add --server-addr option for custom HTTP binding - ([4aa5f23](https://github.com/beyondessential/bestool/commit/4aa5f23207e15f15f3c1ba456d7d17ccde644612))
- **feat(alertd):** Add /alerts endpoint - ([ea7a7e5](https://github.com/beyondessential/bestool/commit/ea7a7e521cabc6e7bd76d15912707ca43f96cff1))
...
- **feat(alertd):** Add /targets route - ([bedaa82](https://github.com/beyondessential/bestool/commit/bedaa823489ec02f54c1a3896d3609c55bef487f))
- **feat(alertd):** Add logging for http server - ([988809f](https://github.com/beyondessential/bestool/commit/988809fab7015839ab5c3c88beeddefd41f5a1e6))
- **feat(alertd):** Send errors to default contact when alert files themselves - ([1dcc5e8](https://github.com/beyondessential/bestool/commit/1dcc5e8253d923d56a3e2821562ee2dbc4de201b))
- **feat(alertd):** Support re-sending duplicate alerts after some time as a - ([65ee3d2](https://github.com/beyondessential/bestool/commit/65ee3d2f314a3884688364c3d12d3b87e13468a2))
...
- **fix(alertd):** Look for _alerts.yml in globbed files as well as dirs - ([b3adbb0](https://github.com/beyondessential/bestool/commit/b3adbb0ac7f0b28cf08fd74514ad9e10a6be0531))
- **fix(alertd):** Don't panic in pg stringifier - ([5be334d](https://github.com/beyondessential/bestool/commit/5be334d93baa59f526d67d8aa33e603a53987980))
- **fix(alertd):** Make miette errors logged by tracing readable - ([f3bc7a1](https://github.com/beyondessential/bestool/commit/f3bc7a130c3a45c939210d32defc5de3db5ced7a))
- **fix(alertd):** Validate alerts before normalisation to catch template - ([21e405f](https://github.com/beyondessential/bestool/commit/21e405fc36cf8d733c1fede01229b97b162f22c8))
- **fix(alertd):** Format those errors properly - ([8c50735](https://github.com/beyondessential/bestool/commit/8c507358b6717f85a5582fad77a4607b796994c3))
- **fix(alertd):** Make sure we're not running alerts that won't be able to - ([4b7d4e2](https://github.com/beyondessential/bestool/commit/4b7d4e2dbb62358ee054d8f7de18a69938981de6))
- **refactor(alertd):** Remove unused slack and zendesk integrations - ([c525e90](https://github.com/beyondessential/bestool/commit/c525e9002751c54b5077f5c462b6d4ffe7764af9))
- **refactor(alertd):** Use subcommands for run and reload - ([f97bc94](https://github.com/beyondessential/bestool/commit/f97bc941244ccf75b2d1456657a136a0222eb8f7))
- **refactor(alertd):** Remove duplicate pg_interval module - ([8e9832d](https://github.com/beyondessential/bestool/commit/8e9832de3011e3ad369d082115c9cbec8dcbeae4))
...
- **refactor(alertd):** Split up http_server module - ([aa68731](https://github.com/beyondessential/bestool/commit/aa687313e4f25511deb6e0032da196ee72102349))
- **tweak(alertd):** Only accept targets from _targets files - ([5f2b573](https://github.com/beyondessential/bestool/commit/5f2b573b524036014d205247c54da5ffbc499b0a))
- **tweak(alertd):** More logging and debugging to see why targets are missing - ([bedaa82](https://github.com/beyondessential/bestool/commit/bedaa823489ec02f54c1a3896d3609c55bef487f))
...
- **refactor(changelog):** Don't group visually by scope - ([7a82ae2](https://github.com/beyondessential/bestool/commit/7a82ae2a8c5035f10c44dc585ddea1434c92665b))

- **feat(psql):** Prompt for password if we need to - ([46a028b](https://github.com/beyondessential/bestool/commit/46a028bf750e3e6ae1df0ad151fc5236fc44537e))
- **fix(psql):** Fix \q not quitting in some cases - ([1c0ae2f](https://github.com/beyondessential/bestool/commit/1c0ae2f395a9c720f58a4d95efa3d1c4085328f4))
